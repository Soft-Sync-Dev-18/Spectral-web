<template>
    <nav
        class="z-50 font-cta  text-[12px] pl-20 pr-20 tracking-[0.1em] h-20 flex w-full flex-1 items-center justify-between uppercase duration-500 height opacity-1 translate-y-0 sticky top-0">
        <a class="absolute left-1/2 top-4 z-50 -translate-x-1/2 justify-center duration-500  translate-y-0" href="/"><svg
                class="h-[40px] scale-y-[-1] xl:h-[50px]" viewBox="0 0 1439 294" fill="none">
                <path
                ...
                <path
                    ...
                    fill="white"></path>
            </svg><span class="sr-only">Spectrum</span></a>
        <ul class="m-0 flex space-x-4 lg:space-x-5">
            <li><a class="no-underline desktop-nav-highlight text-white/70" href="/world">The World</a></li>
            <li><a class="no-underline desktop-nav-highlight text-white/70" href="/explore">Explore</a></li>
            <li><a class="no-underline desktop-nav-highlight text-white/70" href="/obelisk">Obelisk</a></li>
            <li><a class="no-underline desktop-nav-highlight text-white/70" href="/litepaper">Litepaper</a></li>
            <li><a class="no-underline desktop-nav-highlight text-white/70" href="/odk">ODK</a></li>
        </ul>
        <div class="flex items-start space-x-4 lg:space-x-5 h-3">
            <ul class="m-0 flex space-x-6">
                <li class="text-white/70 hidden lg:block"></li>
                <li><a class="no-underline desktop-nav-highlight text-white/70" href="/my-otherdeeds">My Otherdeeds</a></li>
            </ul>
            <div
                class="connect-dropdown relative w-full lg:w-auto mt-14 mb-8 lg:mb-0 text-white lg:-mt-3 flex flex-col justify-start text-center border-white border rounded-sm backdrop-blur-md">
                <button
                    class="relative flex justify-center items-center z-10 text-center uppercase font-cta text-[12px] tracking-[0.1em] w-full py-[10px] h-12 lg:h-9 px-3 lg:px-5 cursor-pointer"><span>Connect</span></button>
                <nav class="relative max-h-0 h-full overflow-hidden z-30" style="height: 0px; max-height: 0px;">
                    <div
                        class="connect-dropdown-list pt-0 lg:pt-0 pb-1 lg:pb-2 px-3 flex flex-col flex-shrink-0 justify-start lg:justify-start text-[12px] leading-[1] font-cta uppercase text-left">
                        <button type="button" class="cta duration-200 backdrop-blur-md" style="opacity: 1;">
                            <span class="flex w-full items-center justify-center text-center">MetaMask</span></button>
                        <a href="https://www.coinbase.com/wallet/getting-started-extension" target="_blank"
                            rel="noopener noreferrer" class="cta duration-200 backdrop-blur-md" style="opacity: 1;"><span
                                class="flex w-full items-center justify-center text-center">Coinbase
                                Wallet</span></a>
                        <button type="button" class="cta duration-200 backdrop-blur-md" style="opacity: 1;"><span
                                class="flex w-full items-center justify-center text-center">WalletConnect</span></button>
                    </div>
                </nav>
            </div>
        </div>
...
<style>
.desktop-nav-highlight:hover::after {
    content: "";
    max-width: 80%;
}
...
.desktop-nav-highlight::after {
    ...
    width: 2.5rem;
    max-width: 0;
    transform: translate(-50%, 0) rotate(0deg) skewX(0deg) skewY(0deg) scale(1, 1);
    --tw-bg-opacity: 1;
    background-color: rgb(38, 47, 247, 1);
    content: "";
...
@media (min-width: 768px) {
    ...
    .connect-dropdown-list a,
    .connect-dropdown-list button {
        --tw-border-opacity: 1;
        border-top-color: rgb(60, 60, 60, 1);
